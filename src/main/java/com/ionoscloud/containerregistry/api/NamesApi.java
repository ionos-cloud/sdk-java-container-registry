...
public class NamesApi {
     ...
     */
    public okhttp3.Call namesCheckUsageCall(String name, final ApiCallback callback ) throws ApiException {
        ...
        return localVarApiClient.buildCall(localVarPath, "HEAD", localVarQueryParams, localVarCollectionQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAuthNames, callback);
    }

    @SuppressWarnings("rawtypes")
    private okhttp3.Call namesCheckUsageValidateBeforeCall(String name, final ApiCallback callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = namesCheckUsageCall(name, callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call namesCheckUsageAsync(String name, final ApiCallback<Void> callback) throws ApiException {

        okhttp3.Call localVarCall = namesCheckUsageValidateBeforeCall(name, callback);
