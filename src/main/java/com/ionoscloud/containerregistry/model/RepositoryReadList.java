...
public class RepositoryReadList {
  ...
  private List<RepositoryRead> items = null;
  ...
  public RepositoryReadList id(IdEnum id) {
  ...
  **/
  ...
  public RepositoryReadList type(TypeEnum type) {
  ...
  **/
  ...
  public RepositoryReadList href(String href) {
   ...
   * @return href
  **/
  @ApiModelProperty(example = "https://api.ionos.com/containerregistries/registries/f39c94e6-e84b-4d25-b54f-75e4289be43c/repositories", required = true, value = "")
  ...
  public RepositoryReadList items(List<RepositoryRead> items) {
    
    this.items = items;
    return this;
  }

  public RepositoryReadList addItemsItem(RepositoryRead itemsItem) {
    if (this.items == null) {
      this.items = new ArrayList<RepositoryRead>();
    }
  ...
  **/
  ...
  public List<RepositoryRead> getItems() {
    return items;
  }


  public void setItems(List<RepositoryRead> items) {
    this.items = items;
  }
  ...
  **/
  ...
  public RepositoryReadList links(Links links) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    RepositoryReadList repositoryReadList = (RepositoryReadList) o;
    return Objects.equals(this.id, repositoryReadList.id) && Objects.equals(this.type, repositoryReadList.type) && Objects.equals(this.href, repositoryReadList.href) && Objects.equals(this.items, repositoryReadList.items) && Objects.equals(this.offset, repositoryReadList.offset) && Objects.equals(this.limit, repositoryReadList.limit) && Objects.equals(this.links, repositoryReadList.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class RepositoryReadList {\n");
