...
public class Links {
  ...
  **/
  ...
  @ApiModelProperty(example = "http://PREVIOUS-PAGE-URI", value = "URL (with offset and limit parameters) of the previous page; only present if offset is greater than 0. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "http://THIS-PAGE-URI", value = "URL (with offset and limit parameters) of the current page. ")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "http://NEXT-PAGE-URI", value = "URL (with offset and limit parameters) of the next page; only present if offset + limit is less than the total number of elements. ")
  ...
  public boolean equals(Object o) {
    ...
    Links links = (Links) o;
    return Objects.equals(this.prev, links.prev) && Objects.equals(this.self, links.self) && Objects.equals(this.next, links.next);
  }
